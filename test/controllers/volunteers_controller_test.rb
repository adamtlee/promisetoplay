...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { description: @volunteer.description, email: @volunteer.email, name: @volunteer.name, phone: @volunteer.phone }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { description: @volunteer.description, email: @volunteer.email, name: @volunteer.name, phone: @volunteer.phone }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
